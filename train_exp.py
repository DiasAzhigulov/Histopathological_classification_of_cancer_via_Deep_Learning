...
BASE_PATH = ['TMAD/','breakhis_m_subtypes_aug/','breakhis_b_subtypes_aug/']
...
for bp in BASE_PATH:
	...
	model_names = ['ResNet152','DenseNet121','DenseNet201','InceptionV3','Xception','VGG16','VGG19','ResNet50']

	model_names1 = ['ResNet101']
	for name in model_names1:
		...
		trainLabels1 = [0 for p in range(len(list(paths.list_images(TRAIN_PATH + subdest[0]))))]
		trainLabels2 = [1 for p in range(len(list(paths.list_images(TRAIN_PATH + subdest[1]))))]
